...
{
### Purpose:- More terms; Tmin, and using 2014 additional data
### ----------------------------------------------------------------------
### Modified from:- plot.developB2
### ----------------------------------------------------------------------
### Arguments:- rnd: how much to round coefficients
###             check.rounding: print out part of predictions
###                             from model and formula if req'd.
### ----------------------------------------------------------------------
### Author:-   Patrick Connolly, Date:- 26 Apr 2013, 16:12
### ----------------------------------------------------------------------
### Revisions:- 
  ...
  options(digits = 10)
  if(post){
    pdf(file = "Non-linearFitC2_N.pdf", height = 195/25.4, width = 270/25.4)
...
##  browser()
  ...
  plot(newdat$T, predM, type = "l", col = colours[1],
       ...
       main = "Non-linear fit using Lactin modified Logan model with min Temp, including intercept",
